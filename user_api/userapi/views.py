...
class UserDetailViewSet(APIView):
    ...
    def get(self, request, format=None):
        ...
        # print(user)
        return JsonResponse({'user':user_no,'user_email':user.user_email,'user_nickname':user.user_nickname,'user_gender':user.user_gender,'user_birthdate':user.user_birthdate}, status = 200)
